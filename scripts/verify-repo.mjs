...
try { const {execFileSync} = await import("node:child_process"); execFileSync("C:\\Users\\USER\\AppData\\Local\\Python\\pythoncore-3.14-64\\python.exe", ["-m", "py_compile", "contracts/genlayer/PRAESTAgreementVault.py", "contracts/genlayer/PRAESTAdjudicator.py"], {stdio: "pipe"}); passes.push("focused contract Python syntax"); } catch { failures.push("focused contract Python syntax failed"); }
